...
let foodBurgers = [
    ...
    FoodCell(foodName: "Bud's Queso Burger", toppings: "Bacon, Sautéed Onions, Jalpeños", image: "quesoBurger", price: "$8.99", type: "Burger"),
    FoodCell(foodName: "Mushroom Brie", toppings: "Lettuce, Tomato, Onion, Mayo, Brie", image: "mush", price: "$8.99", type: "Burger"),
    FoodCell(foodName: "Bacon Egg", toppings: "Lettuce, Tomato, Onion, Mayo, Brie", image: "baconEgg", price: "$8.99", type: "Burger"),
...
let foodSalads = [
    ...
    FoodCell(foodName: "Blue Cheese", toppings: "iceberg, Tomato, Onion, Bacon, Blue Cheese Dressing", image: "blueCheese", price: "$7.99", type: "Salad"),
...
let foodFries = [
    ...
    FoodCell(foodName: "Tator Tots", toppings: "", image: "tots", price: "$3.49", type: "Fry (basically)")
]
let foodApps = [
